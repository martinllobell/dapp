...
const Navbar = ({ toggleDarkMode, darkMode }) => {
  ...
  return (
    <nav style={{backdropFilter: "blur(2px)"}} className={`fixed w-full z-40 h-[5rem] flex justify-between items-center p-6 transition-colors duration-500 ${darkMode ? 'dark' : ''}`}>
